...
### 1.1) Стратегия масштабирования (вертикальное vs горизонтальное)
- **Приложения (веб/API):** горизонтальное масштабирование — HPA, реплики подов в Kubernetes; эффективнее для переменной нагрузки и отказоустойчивости.
- **База данных:** при текущем объёме (~50 GB) — вертикальное масштабирование + репликация между AZ; при росте — пересмотр, см. п. 5.
